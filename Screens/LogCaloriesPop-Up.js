...
const LogCaloriesPopUp = ({ userId }) => {
  ...
  const fetchUserData = async () => {
    try {
      ...
      if (userDoc.exists()) {
        ...
        setCal1(userDoc.data().calorie1 || '');
        setCal2(userDoc.data().calorie2 || '');
        setCal3(userDoc.data().calorie3 || '');
        setCal4(userDoc.data().calorie4 || '');
      } else {
  ...
  const updateCalories = async (calNumber) => {
    try {
      ...
      const calorieValue = calNumber === 1 ? parseInt(cal1) : calNumber === 2 ? parseInt(cal2) : calNumber === 3 ? parseInt(cal3) : parseInt(cal4);
  ...
  return (
    <View style={styles.LogCaloriesPopUp}>
      ...
      <View style={[styles.boxPosition1, styles.boxPositionLayout]}>
        ...
        <TouchableOpacity
          style={styles.image}
          onPress={() => updateCalories(1)}
        >
          <Image
            resizeMode="cover"
            source={require("./Assets/ActivityScreen/Plus.png")}
          />
        </TouchableOpacity>
      </View>
      ...
      <View style={[styles.boxPosition2, styles.boxPositionLayout]}>
        ...
        <TextInput
          ...
          placeholder={cal2 ? cal2.toString() : "0"}
          placeholderTextColor={"white"}
          style={styles.cal}
        />
        <TouchableOpacity
          style={styles.image}
          onPress={() => updateCalories(2)}
        >
          <Image
            resizeMode="cover"
            source={require("./Assets/ActivityScreen/Plus.png")}
      ...
      <View style={[styles.boxPosition4, styles.boxPositionLayout]}>
        ...
        <TextInput
          ...
          placeholder={cal4 ? cal4.toString() : "0"}
